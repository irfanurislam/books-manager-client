...
const EditBooks = () => {
  ...
  >
    <div className="col-md-6">
      ...
      <input
        type="name"
        defaultValue={allBooks.bookName}
        name="bookName"
    ...
    <div className="col-md-6">
      ...
      <input
        type="name"
        defaultValue={allBooks.authorName}
        name="authorName"
        className="form-control"
        id="authorName"
      />
    ...
    <div className="col-12">
      ...
      <input
        type="url"
        defaultValue={allBooks.imageUrl}
        name="imageUrl"
        className="form-control"
        id="imageUrl"
      />
    ...
    <div className="col-md-4">
      ...
      <select
        id="inputState"
        defaultValue={allBooks.categoryName}
        name="categoryName"
    ...
    <div className="col-md-8">
      ...
      <textarea
        type="text"
        className="form-control"
        defaultValue={allBooks.metaTextDescription}
    ...
    <div className="col-12">
      <div class="mb-3">
        ...
        <input
          name="bookPDF"
          defaultValue={allBooks.bookPdfUrl}
          class="form-control"
          type="url"
          id="formFile"
        />
